    ...
    <Box sx={{ maxWidth: 600, mx: 'auto', p: 3 }}>
      <Paper elevation={2} sx={{ p: 2 }}>
        ...
        <Typography variant="body1" paragraph>
          ...
          and you are encouraged to contribute! Pull requests are very welcome! If you have suggestions or improvements,
          please contribute to this project.
        </Typography>
        <Typography variant="body1">
          It&apos;s built with React and uses Material Design styles, providing a modern and responsive user interface.
        </Typography>
      </Paper>
    </Box>
  );
